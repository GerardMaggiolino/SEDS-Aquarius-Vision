...
class LanderCNN(nn.Module): 
    ...
    def __init__(self): 
        ...
        self.conv_layers = nn.ModuleList([
            # First normal conv layer 251 -> 123
            pad,
            nn.Conv2d(1, 8, 7, stride=2, bias=False),
            nn.BatchNorm2d(8),
            act,
            # First depthwise separable convolution 123 -> 60
            nn.Conv2d(8, 8, 5, stride=2, bias=False, groups=8),
            nn.BatchNorm2d(8),
            act,
            nn.Conv2d(8, 16, 1, bias=False),
            nn.BatchNorm2d(16),
            act,
            # Second depthwise separable convolution 61 -> 30 
            pad, 
